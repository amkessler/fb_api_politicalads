...
sampleforbpi <- head(content_df_tibble, )

#add unique id
sampleforbpi <- rowid_to_column(sampleforbpi, "cnnID")



tibb <- sampleforbpi

## function to export dataframe with list columns to csv ####
...
#apply it
tibble_with_lists_to_csv(tibb, 'sample2forbpi_wlistcols.csv')
